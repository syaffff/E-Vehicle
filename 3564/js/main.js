...
(function ($) {
	...
	$(document).ready(function () {
		...
		$("#sub-title").wordsrotator({
			...
			words: ['<span style="color:powderblue">Do these here</span>','<span style="color:powderblue">Apply your vehicle sticker</span>', '<span style="color:powderblue">Check your summon</span>'] //Array of words, it may contain HTML values
		});
