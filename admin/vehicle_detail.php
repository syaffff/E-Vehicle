...
if(isset($_GET['detail']))
    {
       $vehicleID=$_GET['detail'];


            //$sql1 = mysqli_query($conn,'SELECT * FROM user WHERE icNo = "'.$icNo.'"');
			
		$sql = mysqli_query($conn,'SELECT u.* , o.* , v.* FROM user u , owner o , vehicle v WHERE o.vehicleID="'.$vehicleID.'" and o.icNo=u.icNo and v.vehicleID=o.vehicleID');
		             ...
		             while($row = mysqli_fetch_array($sql))
		                {
							...
							$vehicleRoadTaxDate = $row['vehicleRoadTaxDate'];
                    ...
                    <p>&nbsp;</p>
                        ...
                        <form action='' method='post'>
                          <table align='center'>
                            ...
                            <tr valign='baseline'>
                              <td nowrap='nowrap' text-align='right'>Matric Card Or Staff Card Picture:</td>
