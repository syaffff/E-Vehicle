...
{
	$new1 = strtoupper($_POST['vehicleID']);
	$new2 = preg_replace('/\s+/', '', $new1);;
	
  $insertSQL = "INSERT INTO vehicle (vehicleID, vehicleType, vehicleRoadTaxDate) VALUES ('$new2', '$_POST[vehicleType]', '$_POST[vehicleRoadTaxDate]')";
					   
  $insertSQL2 = "INSERT INTO owner (vehicleID, icNo, status, semester) VALUES ('$new2', '$_SESSION[MM_Username]', 'IN PROCESS', 'SEMESTER 2 2017/2018')";
  ...
  if($Result1 && $Result2)
  {
	  echo "<script type=\"text/javascript\">".
			"alert('Vehicle details has been sent to be processed.');".
			"</script>";
  } else
  {
	  echo "<script type=\"text/javascript\">".
			"alert('Oops! Something is wrong. Please insert the form again');".
			"</script>";
  }
}
...
<body>
		...
		<aside id="sidebar" class="column-left">
			...
			<nav id="mainnav">
  				<ul>
                <li class="selected-item"><a href="application.php">Application</a></li>
          ...
          <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
           <table>
              ...
              <tr valign="baseline">
                ...
                <td align="left"><input type="date" name="vehicleRoadTaxDate" size="32" min="<?php echo $min ?>"/></td>
              </tr>
              <tr valign="baseline">
