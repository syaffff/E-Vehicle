...
<head>
	...
	<link href="../3564/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<link href="../3564/js/wow/css/libs/animate.css" rel="stylesheet">
	<link href="../3564/js/wordsrotator/jquery.wordrotator.min.css" rel="stylesheet">
	<!-- CSS IMPORT FOR FONT -->
	<link href='https://fonts.googleapis.com/css?family=Oswald:400,300' rel='stylesheet' type='text/css'>
	<link href='https://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
	<link href='../3564/fonts/font-awesome/css/font-awesome.min.css' rel='stylesheet' type='text/css'>
	<!-- CSS IMPORT FOR MAIN STYLE -->
	<link href="../3564/css/style.css" rel="stylesheet">
    ...
    <![endif]-->
	<!-- 4.0 FAVICON -->
	<link rel="shortcut icon" href="../3564/img/favicon.png">
</head>
...
<body>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-sm-12 text-center">
					...
					<!-- 6.3 ERROR CODE -->
					<h1 class="wow flipInY" data-wow-delay="1.5s">UTeM</h1>
					...
					<form class="form-inline search-form">
						<div class="input-group">
							<input type="type" class="form-control" placeholder="Identification Card Number (NRIC)">
	...
	<!-- bootstrap -->
	<script src="../3564/bootstrap/js/bootstrap.min.js"></script>
	<!-- wow -->
	<script src="../3564/js/wow/dist/wow.min.js"></script>
	<!-- wordsrotator -->
	<script src="../3564/js/wordsrotator/jquery.wordrotator.min.js"></script>
	<!-- main js -->
	<script src="../3564/js/main.js"></script>
</body>
